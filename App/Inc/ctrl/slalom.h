 ...
 */
static constexpr float dddth_max_default = 80000*consts::physics::DEG2RAD;
/**
 * @brief 最大角加速度のデフォルト値 [rad/s/s]
 */
static constexpr float ddth_max_default = 2500*consts::physics::DEG2RAD;
/**
 * @brief 最大角速度のデフォルト値 [rad/s]
 */
static constexpr float dth_max_default = 800 * consts::physics::DEG2RAD;
