...
namespace peripheral {
    ...
    //+++++++++++++++++++++++++++++++++++++++++++++++
    HAL_StatusTypeDef EEPROM::EnableWrite(void) {
    ...
    // 戻り値：問題が起こらなければHAL_OKを返す
    //+++++++++++++++++++++++++++++++++++++++++++++++
    HAL_StatusTypeDef EEPROM::DisableWrite(void) {
    ...
    //+++++++++++++++++++++++++++++++++++++++++++++++
    HAL_StatusTypeDef EEPROM::WriteHalfword(uint32_t address, uint16_t data) {
        HAL_StatusTypeDef status;
    ...
    //+++++++++++++++++++++++++++++++++++++++++++++++
    HAL_StatusTypeDef EEPROM::WriteWord(uint32_t address, uint32_t data) {
        HAL_StatusTypeDef status;
    ...
    //+++++++++++++++++++++++++++++++++++++++++++++++
    uint16_t EEPROM::ReadHalfword(uint32_t address) {
        uint16_t val = 0;
        address = address * 2 + EEPROM_START_ADDRESS;
    ...
    //+++++++++++++++++++++++++++++++++++++++++++++++
    uint32_t EEPROM::ReadWord(uint32_t address) {
    uint32_t val = 0;
    address = address * 4 + EEPROM_START_ADDRESS;
