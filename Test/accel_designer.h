...
class AccelDesigner {
 public:
   ...
   * @brief 初期化付きコンストラクタ
   *
   * @param[in] j_max     最大躍度の大きさ [mm/s/s/s]、正であること
   * @param[in] a_max     最大加速度の大きさ [mm/s/s], 正であること
   * @param[in] v_max     最大速度の大きさ [mm/s]、正であること
   * @param[in] v_start   始点速度 [mm/s]
   * @param[in] v_target  目標速度 [mm/s]
   * @param[in] dist      移動距離 [mm]
   * @param[in] x_start   始点位置 [mm] (オプション)
